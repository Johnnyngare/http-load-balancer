...
try:  # Compiled with SSL?
    ...
    BaseSSLError = ssl.SSLError # type: ignore
...
class HTTPSConnection(HTTPConnection):
    ...
    def __init__(
        ...
        *,
        ...
        ssl_context: ssl.SSLContext | None = None, # type: ignore
        ca_certs: str | None = None,
        ca_cert_dir: str | None = None,
        ca_cert_data: None | str | bytes = None,
        ssl_minimum_version: int | None = None,
    ...
    def connect(self) -> None:
        sock: socket.socket | ssl.SSLSocket # type: ignore
        ...
        sock_and_verified = _ssl_wrap_socket_and_match_hostname(
            ...
            assert_hostname=self.assert_hostname, # type: ignore
    ...
    def _connect_tls_proxy(self, hostname: str, sock: socket.socket) -> ssl.SSLSocket: # type: ignore
        """
...
class _WrappedAndVerifiedSocket(typing.NamedTuple):
    ...
    socket: ssl.SSLSocket | SSLTransport # type: ignore
    is_verified: bool
...
def _ssl_wrap_socket_and_match_hostname(
    ...
    *,
    ...
    ssl_context: ssl.SSLContext | None, # type: ignore
    ...
    try:
        if assert_fingerprint:
            ...
            context.verify_mode != ssl.CERT_NONE # type: ignore
        ...
        return _WrappedAndVerifiedSocket(
            socket=ssl_sock,
            is_verified=context.verify_mode == ssl.CERT_REQUIRED # type: ignore
